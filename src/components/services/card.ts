export function createCard(title: string, text: string, icon: string) {
  ...
  card.className =
    'flex flex-col p-4 bg-neutral rounded-3xl xs:p-10 group hover:origin-bottom hover:-translate-y-6 transition-all duration-300 is-in-out';
  ...
  cardTitle.className = 'text-xl font-bold text-dark font-quicksand min-w-[139px]';
