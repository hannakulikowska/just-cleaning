export function createHeadlineBlock() {
  ...
  container.className = 'lg:pr-8 lg:pt-2 lg:max-w-6xl';
  ...
  const subtitleTextParts = [
    'Jesteśmy lokalną firmą, która specjalizuje się w chemicznym ',
    'czyszczeniu i praniu tapicerki meblowej',
    ' na terenie ',
    'Szczecina, Stargardu i okolic',
